...
local function highlights(palette)
    ...
    local property_text_color = palette.pink
    ...
    return {
        ...
        statusline = {
            ...
            StatusLineAutoformatEnabled = { fg = palette.yellow },
            ...
            StatusLineModeNormalText = { bg = "NONE", fg = palette.yellow, bold = true },
        ...
        syntax = {
            ...
            Italic = { italic = true },
            Keyword = { fg = palette.yellow, italic = true },
            Label = { link = "Keyword" },
            Macro = { link = "PreProc" },
