...
local function highlights(palette)
    ...
    return {
        ...
        scrollbar = {
            ...
            ScrollbarCursorHandle = { fg = palette.love, bg = palette.scrollbar_thumb },
            ScrollbarSearch = { fg = palette.text },
            ScrollbarSearchHandle = { fg = palette.text, bg = palette.scrollbar_thumb },
            ScrollbarError = { fg = palette.rose },
            ScrollbarErrorHandle = { fg = palette.rose, bg = palette.scrollbar_thumb },
            ScrollbarWarn = { fg = palette.gold },
            ScrollbarWarnHandle = { fg = palette.gold, bg = palette.scrollbar_thumb },
            ScrollbarInfo = { fg = palette.foam },
            ScrollbarInfoHandle = { fg = palette.foam, bg = palette.scrollbar_thumb },
            ScrollbarHint = { fg = palette.iris },
            ScrollbarHintHandle = { fg = palette.iris, bg = palette.scrollbar_thumb },
