...
local function highlights(palette)
    ...
    local function_text_color = palette.love
    local metadata_text_color = palette.iris
    local type_text_color = palette.foam
    ...
    local git_changed_text_color = palette.gold
    local git_changed_background_color = palette.gold_background
    ...
    return {
        ...
        statusline = {
            ...
            StatusLineGitBranch = { fg = palette.foam },
            ...
            StatusLineModeInsert = { bg = palette.foam, fg = palette.base, bold = true },
            StatusLineModeInsertText = { bg = "NONE", fg = palette.foam, bold = true },
            ...
            StatusLineModeInsertSubtle = { bg = c.desaturate(palette.foam_background, 10) },
