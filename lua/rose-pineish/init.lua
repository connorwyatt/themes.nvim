...
local function highlights(palette)
    ...
    local selection_background_color = palette.highlight_med

    local separator_color = palette.highlight_high

    local variable_text_color = palette.text
    local parameter_text_color = palette.iris
    local constant_text_color = palette.iris
    local property_text_color = palette.leaf
    local keyword_text_color = palette.love
    local number_text_color = palette.love
    local boolean_text_color = palette.love
    local string_text_color = palette.gold
    local function_text_color = palette.foam
    local metadata_text_color = palette.leaf
    local type_text_color = palette.gold
    ...
    local file_text_color = palette.gold
    ...
    local git_removed_text_color = palette.love
    local git_removed_background_color = palette.love_background
    ...
    return {
        blink_cmp = {
            ...
            BlinkCmpKindSnippet = { fg = palette.surface, bg = palette.love },
        ...
        dap_ui = {
            ...
            DapUIStop = { fg = palette.love, bg = palette.surface },
            DapUIStopNC = { fg = palette.love, bg = palette.surface },
            ...
            DapUIWatchesError = { fg = palette.love },
        ...
        diagnostics = {
            ...
            DiagnosticVirtualTextError = { fg = palette.love, bg = palette.love_background },
        ...
        editor = {
            ...
            SpellBad = { sp = palette.gold, underdotted = true },
            SpellCap = { sp = palette.gold, underdotted = true },
            SpellLocal = { sp = palette.iris, underdotted = true },
            SpellRare = { sp = palette.iris, underdotted = true },
        ...
        folds = {
            Folded = {},
            FoldText = { fg = palette.love },
        },
        fyler = {
            FylerRed = { fg = palette.love },
        ...
        snacks = {
            ...
            SnacksIndentScope = { fg = palette.love },
            SnacksPickerMatch = { fg = palette.love, bold = true, underline = true },
        },
        statusline = {
            ...
            StatusLineFileModified = { fg = palette.foam },
            StatusLineFileReadonly = { fg = palette.gold },
            StatusLineGitAdded = { fg = git_added_text_color },
            StatusLineGitBranch = { fg = palette.gold },
            ...
            StatusLineModeCommand = { bg = palette.leaf, fg = palette.overlay, bold = true },
            StatusLineModeCommandText = { bg = "NONE", fg = palette.leaf, bold = true },
            StatusLineModeInsert = { bg = palette.gold, fg = palette.overlay, bold = true },
            StatusLineModeInsertText = { bg = "NONE", fg = palette.gold, bold = true },
            StatusLineModeNormal = { bg = palette.love, fg = palette.overlay, bold = true },
            StatusLineModeNormalText = { bg = "NONE", fg = palette.love, bold = true },
            StatusLineModeReplace = { bg = palette.love, fg = palette.overlay, bold = true },
            StatusLineModeReplaceText = { bg = "NONE", fg = palette.love, bold = true },
            StatusLineModeSelect = { bg = palette.love, fg = palette.overlay, bold = true },
            StatusLineModeSelectText = { bg = "NONE", fg = palette.love, bold = true },
            StatusLineModeTerminal = { bg = palette.iris, fg = palette.overlay, bold = true },
            StatusLineModeTerminalText = { bg = "NONE", fg = palette.iris, bold = true },
            StatusLineModeVisual = { bg = palette.foam, fg = palette.overlay, bold = true },
            StatusLineModeVisualText = { bg = "NONE", fg = palette.foam, bold = true },
            StatusLineModeCommandSubtle = { bg = c.desaturate(palette.leaf_background, 10) },
            StatusLineModeInsertSubtle = { bg = c.desaturate(palette.gold_background, 10) },
            StatusLineModeNormalSubtle = { bg = c.desaturate(palette.love_background, 10) },
            StatusLineModeReplaceSubtle = { bg = c.desaturate(palette.love_background, 10) },
            StatusLineModeSelectSubtle = { bg = c.desaturate(palette.love_background, 10) },
            StatusLineModeTerminalSubtle = { bg = c.desaturate(palette.iris_background, 10) },
            StatusLineModeVisualSubtle = { bg = c.desaturate(palette.foam_background, 10) },
        ...
        syntax = {
            ...
            Italic = { italic = true },
            Keyword = { fg = palette.love, italic = true },
            Label = { link = "Keyword" },
            Macro = { link = "PreProc" },
...
local function terminal_highlights(palette)
    if palette.is_dark then
        return {
            ...
            red = palette.love,
            red_bright = c.lighten(palette.love, 15),
            green = palette.leaf,
            green_bright = c.lighten(palette.leaf, 15),
            yellow = palette.gold,
            yellow_bright = c.lighten(palette.gold, 15),
            blue = palette.iris,
            blue_bright = c.lighten(palette.iris, 15),
            magenta = palette.love,
            magenta_bright = c.lighten(palette.love, 15),
            cyan = palette.foam,
